...
const Input = forwardRef<TextInput, InputProps>(({
  ...
  return (
    <View className="mb-4">
      ...
      <View
        className={`
          relative flex-row items-center border rounded-lg bg-white
          ${hasError 
      ...
      >
        ...
        <TextInput
          ref={ref}
          className={`
            flex-1 p-4 text-gray-900 text-base
            ${leftIcon ? 'pl-12' : ''}
        ...
        {(showPasswordToggle || rightIcon) && (
          <TouchableOpacity
            ...
            testID={showPasswordToggle ? `${testID}-password-toggle` : `${testID}-right-icon`}
          >
            <Ionicons
              name={
                showPasswordToggle
