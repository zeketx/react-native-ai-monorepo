...
async function testCMSConnectivity() {
  ...
  try {
    ...
    console.log('❌ CMS not reachable:', error instanceof Error ? error.message : 'Unknown error')
  ...
  try {
    ...
    console.log('❌ Users endpoint error:', error instanceof Error ? error.message : 'Unknown error')
  }
  ...
  try {
    ...
    console.log('❌ Auth service error:', error instanceof Error ? error.message : 'Unknown error')
    return false
  }
...
async function runConnectionTests() {
  ...
  if (envOk && connectivityOk) {
    ...
    if (!envOk) {
      console.log('💡 Environment: Copy .env.example to .env.local and configure')
    }
